...
const Modal = (props) => {
  const { header, children, footer, closeModal } = props;
  return (
    <>
      <div
      ...
      >
        <div className='relative w-auto my-6 mx-auto max-w-3xl'>
          ...
          <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
            ...
            {/*footer*/}
            <div className='flex items-center justify-end p-6 border-t border-solid border-gray-300 rounded-b'>{footer}</div>
          </div>
        </div>
      </div>
